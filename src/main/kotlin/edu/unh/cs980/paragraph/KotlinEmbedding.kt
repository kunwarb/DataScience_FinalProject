...
class KotlinEmbedding(indexLoc: String, gramLoc: String) {
    ...
    fun loadTopics(directory: String) {
        ...
        kernelAnalyzer.normalizeTopics(false)
    }
    ...
    fun embed(text: String, nSamples: Int = 300): TopicMixtureResult {
        val kernelDist = KernelDist(0.0, 10.0)
            ...
            .apply { (0 until 30).forEach { normalizeByCond() } }
...
//            .map { doc -> KernelDist(0.0, 1.0).apply {
//                analyzePartitionedDocument(doc)
...
//            File("paragraphs/Computers/doc_1.txt").readText()
    ...
    val result = embedder.embed(testText, nSamples = 250)
